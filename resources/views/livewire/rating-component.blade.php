    ...
    <div class="row justify-content-center">
        ...
        <div>
            <div class="rating-container">
                <div class="rating" wire:click="updated('1')" style="cursor: pointer;">
                    <img src="{{ asset('image/happy.png') }}" alt="Sangat Puas">
                    <p>Sangat Puas</p>
                </div>
                <div class="rating" wire:click="$set('ratings', '2')" style="cursor: pointer;">
                    <img src="{{ asset('image/smile.png') }}" alt="Puas">
                    <p>Puas</p>
                </div>
                <div class="rating" wire:click="$set('ratings', '3')" style="cursor: pointer;">
